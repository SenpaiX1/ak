...
function js_scale_canvas(baseWidth, baseHeight, targetWidth, targetHeight) {
  ...
  var backStoreRatio = (g_CurrentGraphics.webkitBackingStorePixelRatio || g_CurrentGraphics.mozBackingStorePixelRatio || g_CurrentGraphics.msBackingStorePixelRatio || g_CurrentGraphics.oBackingStorePixelRatio || g_CurrentGraphics.backingStorePixelRatio || 1);
...
function js_UpdateInvisibleButton(buttonID, x1, y1, x2, y2, link, active) {
  ...
  btn.style.left = parseInt(canvas.style.left, 10) + x1 * scale_scr + "px";
  btn.style.top = parseInt(canvas.style.top, 10) + y1 * scale_scr + "px";
